...
<head>
    ...
    <link rel="stylesheet" href="css/estilo_rombo.css"> <!-- Incluye el nuevo CSS -->
</head>
...
<body>
    <header>
        <nav>
            <ul>
                <li><a href="menu_admin.html"> Menu </a></li>
                <li class="header__nav-item"><button><a href="menu_admin.html"> Regresar </a></button></li>
